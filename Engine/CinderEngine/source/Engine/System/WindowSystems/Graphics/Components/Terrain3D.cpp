...
namespace Framework
{
  ...
  void Terrain3D::Draw()
  {
    ...
    shader->uniMat4("mvp", glm::value_ptr(gameObject->C<Transform>()->GetModelViewProjectionMatrix()));

    shader->uniMat4("modelMatrix", glm::value_ptr(gameObject->C<Transform>()->GetModelMatrix()));
